                            ...
                            <div class="col-lg-12">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <p class="text-muted mb-3">Enter your otp.
                                        </p>
                                        ...
                                        <form action="{{ url('/verify-otp') }}" method="POST">
                                             @csrf
                                            <div class="mb-3">
                                                  <input class="form-control"  id="emailaddress" type="hidden" placeholder="Enter your email" value="{{ session('email') ? session('email') : $email}}" name="email">
                                                <label for="emailaddress" class="form-label">Enter Otp</label>
                                                <input class="form-control" type="text" id="emailaddress" required=""
                                                    placeholder="Enter your otp" value="{{ old('opt') }}" name="otp">
                                            </div>
