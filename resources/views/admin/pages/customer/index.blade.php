  ...
  <!-- start page title -->
                        ...
                        <!-- end page title -->
                         ...
                         <div class="card">
                                    ...
                                    <form action="{{  route("customer.index") }}"  method="GET" novalidate>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('customer.create') }}" class="btn btn-primary" style="color: white;">Add New Customer</a>
                                            </div>
                                            <h5 class="header-title mb-0">Customer List</h5>
                                        </div>
