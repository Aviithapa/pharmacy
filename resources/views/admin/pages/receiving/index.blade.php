  ...
  <!-- start page title -->
                        ...
                        <!-- end page title -->
                         ...
                         <div class="card">
                                    ...
                                    <form action="{{  route("receiving.index") }}"  method="GET" novalidate>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('receiving.create') }}" class="btn btn-primary" style="color: white;">Add New Receiving </a>
                                            </div>
                                            <h5 class="header-title mb-0">Receiving List</h5>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        @foreach($datas as $key => $data)
                                                         @php
                                                            ...
                                                            <td><a href="{{ route('receiving.edit', ['receiving' => $data->id]) }}"><span class="badge bg-info-subtle text-info">Edit</span></a>
                                                            </td>
